...
class FetchUpdatedParallels
  ...
  def perform(last_updated_since: nil, last_updated_till: nil, faculty_semester: nil, fetch_all: true)
    last_update_at = last_updated_since || get_last_updated_date
    updated_parallels = @finder.find_updated(last_update_at, last_updated_till, faculty: faculty_semester.faculty, semester: faculty_semester.code)
