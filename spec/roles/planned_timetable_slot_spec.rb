...
describe PlannedTimetableSlot do
  ...
  let(:slot_with_weeks_and_times) { double(id: 1, first_hour: 1, duration: 2, parity: nil, day: 1, start_time: Time.parse('1901-01-01 07:30:00'), end_time: Time.parse('1901-01-01 08:10:00'), weeks: [(1..1), (3..3)]) }
